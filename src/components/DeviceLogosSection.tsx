...
const DeviceLogosSection = () => (
  <section className="py-24 relative overflow-hidden">
    ...
    <div className="container relative z-10">
      ...
      >
        <span className="section-badge mb-4 inline-flex">📱 Multi-Device</span>
        <h2 className="font-heading text-3xl md:text-5xl font-bold mt-2">Stream Anywhere, Anytime</h2>
      ...
      >
        <div className="relative rounded-2xl overflow-hidden border border-border/40 shadow-2xl">
          <Image
            src="/assets/devices-showcase.webp"
